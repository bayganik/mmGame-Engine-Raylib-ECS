...
namespace mmGameEngine
{
	...
	public partial class TmxMap : TmxDocument
	{
		...
		public Vector2 WorldToTilePosition(Vector2 pos, bool clampToTilemapBounds = true)
		{
			return new Vector2(WorldToTilePositionX(pos.X, clampToTilemapBounds), WorldToTilePositionY(pos.Y, clampToTilemapBounds));
