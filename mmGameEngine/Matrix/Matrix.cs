...
namespace mmGameEngine
{
	public struct Matrix : IEquatable<Matrix>
	{
		...
		public static Matrix CreateLookAt(Vector3 cameraPosition, Vector3 CameraEntityToFollow, Vector3 cameraUpVector)
		{
			Vector3 vector3_1 = Vector3.Normalize(cameraPosition - CameraEntityToFollow);
			...
			var diff = cameraPosition - CameraEntityToFollow;
			diff.Normalize();
			m.Forward = -diff;
		...
		public static void CreateLookAt(ref Vector3 cameraPosition, ref Vector3 CameraEntityToFollow, ref Vector3 cameraUpVector, out Matrix result)
		{
			Vector3 vector = Vector3.Normalize(cameraPosition - CameraEntityToFollow);
