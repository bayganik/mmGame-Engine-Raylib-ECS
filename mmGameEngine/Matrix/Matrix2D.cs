...
{
	/// <summary>
	/// Represents the right-handed 3x3 floating point matrix, which can store translation, scale 
	...
	public struct Matrix2D : IEquatable<Matrix2D>
	{
		...
		public float M12; //sin rotation

		public float M21; //cos rotation
		...
		public static Matrix3x2 Convert(Matrix2D _matrix2D)
		{
			Matrix3x2 tmp = new Matrix3x2();
			tmp.M11 = _matrix2D.M11;
			tmp.M12 = _matrix2D.M12;
			tmp.M22 = _matrix2D.M22;
			tmp.M31 = _matrix2D.M31;
			tmp.M32 = _matrix2D.M32;
